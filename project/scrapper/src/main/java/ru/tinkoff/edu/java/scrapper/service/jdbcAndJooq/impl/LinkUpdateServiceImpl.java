...
public class LinkUpdateServiceImpl implements LinkUpdateService {
    ...
    public void updateGitHubLink(Link link, Parser_Link result) {
        try {
            boolean isUpdated = false;
            String updateDescription = "";

            GitHubResponse response = gitHubClient.fetchRepo(
                ((GitHub_Link) result).username(),
                ((GitHub_Link) result).repository()
            );
    ...
    public void updateStackOverflowLink(Link link, Parser_Link result) {
        try {
            ...
            StackOverflowItem response =
                stackOverflowClient.fetchQuestion(((StackOverflow_Link) result).id());
